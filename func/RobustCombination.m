...
% MP2RAGEimg is a phase sensitive coil combination... some more math has to
...
%% Calculate lambda
% Usually the multiplicative factor shouldn't be greater than 10, but that is not the case when the image is
